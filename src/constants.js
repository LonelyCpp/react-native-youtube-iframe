...
// When bumping, also update "version" in iframeVersion.json
export const IFRAME_VERSION = 2;

export const DEFAULT_BASE_URL = `https://lonelycpp.github.io/react-native-youtube-iframe/iframe_v${IFRAME_VERSION}.html`;
